...
\thesisauthor{Jaroslav Cimrman} % jmeno autora prace, l
\thesissupervisor{prof. doc. Ing. Jméno Příjmení, PhD.} % jmeno vedouciho
\thesistitle{Název práce} % nazev prace
...
\input{chapters/intro.tex} % vlozi kapitolu 1
\input{chapters/example.tex} % vlozi kapitolu 2
\input{chapters/abbreviations.tex} % vlozi zkratky
\input{chapters/bibliography.tex} % vlozi zkratky
